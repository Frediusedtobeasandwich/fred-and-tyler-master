            ...
            switch (shape)
            {
                case 0:
                    if (rotationCount == 1)//T
                    {
                        ...
                        Rectangle playBlock = new Rectangle(heroX + 20, heroY, 60, 20);
                        Rectangle playBlock2 = new Rectangle(heroX, heroY - 20, 20, 20);
                        checkCollisions(bottomBlock, playBlock, playBlock2);
                    }
                    ...
                    else if (rotationCount == 2)
                    {
                        ...
                        Rectangle playBlock = new Rectangle(heroX, heroY - 20, 20, 60);
                        Rectangle playBlock2 = new Rectangle(heroX + 20, heroY, 20, 20);
                        checkCollisions(bottomBlock, playBlock, playBlock2);
                    }
                ...
                case 1://Z
                    if (rotationCount == 1 || rotationCount == 3)
                    {
                        ...
                        Rectangle playBlock = new Rectangle(heroX - 20, heroY, 40, 20);
                        Rectangle playBlock2 = new Rectangle(heroX, heroY - 20, 40, 20);
                        checkCollisions(bottomBlock, playBlock, playBlock2);
                    }
                    else if (rotationCount == 2 || rotationCount == 4)
                    {
                        ...
                        Rectangle playBlock = new Rectangle(heroX, heroY - 20, 20, 40);
                        Rectangle playBlock2 = new Rectangle(heroX + 20, heroY, 20, 40);
                        checkCollisions(bottomBlock, playBlock, playBlock2);
                    }
                    break;
                case 2://S
                    if (rotationCount == 1 || rotationCount == 3) 
                    {
                        ...
                        Rectangle playBlock = new Rectangle(heroX - 20, heroY - 20, 40, 20);
                        Rectangle playBlock2 = new Rectangle(heroX, heroY, 40, 20);
                        checkCollisions(bottomBlock, playBlock, playBlock2);
                    }
                    else if (rotationCount == 2 || rotationCount == 4)
                    {
                ...
                case 3://L
                    if (rotationCount == 1)
                    {
                        ...
                        Rectangle playBlock = new Rectangle(heroX, heroY - 40, 20, 60);
                        Rectangle playBlock2 = new Rectangle(heroX + 20, heroY, 20, 20);
                        checkCollisions(bottomBlock, playBlock, playBlock2);
                    }
                    else if (rotationCount == 2)
                    {
                        ...
                        Rectangle playBlock = new Rectangle(heroX, heroY, 60, 20);
                        Rectangle playBlock2 = new Rectangle(heroX, heroY + 20, 20, 20);
                        checkCollisions(bottomBlock, playBlock, playBlock2);
                    }
                    else if (rotationCount == 3)
                    {
                        ...
                        Rectangle playBlock = new Rectangle(heroX, heroY, 20, 60);
                        Rectangle playBlock2 = new Rectangle(heroX - 20, heroY, 20, 20);
                        checkCollisions(bottomBlock, playBlock, playBlock2);
                    }
                    else if (rotationCount == 4)
                    {
                        ...
                        Rectangle playBlock = new Rectangle(heroX - 40, heroY, 60, 20);
                        Rectangle playBlock2 = new Rectangle(heroX, heroY - 20, 20, 20);
                        checkCollisions(bottomBlock, playBlock, playBlock2);
                    }
                    break;
                ...
                case 5://O
                    if (rotationCount > 0) 
                    {
                        ...
                        Rectangle playBlock = new Rectangle(heroX, heroY, 40, 40);
                        Rectangle playBlock2 = new Rectangle(heroX, heroY, 40, 40);
                        checkCollisions(bottomBlock, playBlock, playBlock2);
                    }
                    break;
            }
        }
        public void checkCollisions(Rectangle bottomBlock, Rectangle playBlock, Rectangle playBlock2)
        {
            while (bottomBlock.IntersectsWith(playBlock) || bottomBlock.IntersectsWith(playBlock2))
            {
                if (leftArrowDown == true)
                {
                    heroSpeed = 0;
